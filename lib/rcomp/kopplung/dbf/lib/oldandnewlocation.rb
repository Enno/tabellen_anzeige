...
#2007-Okt-16, SvenS:
# Workaround, damit diese Datei von script.rb gelesen werden kann
dir_superklasse = case self.class.to_s 
when "Object"  then
  Object
when /Script/ then
  Dir
else
  raise "Toplevel von unbekanntem Typ"
end

class Dir < dir_superklasse # nur nötig für script.rb
